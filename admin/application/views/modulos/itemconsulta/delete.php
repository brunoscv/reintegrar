<div class="page-breadcrumb">
    <ol class="breadcrumb container">
        ...
        <li><a href="<?php echo site_url("usuarios")?>">Item_consulta</a></li>
        <li>Remover   </li>
    </ol>
</div>
						...
						<div class="col-md-8" data-container="main">
							<div class="panel panel-default">
								<div class="panel-heading clearfix">
				                    <h4 class="panel-title">Controle de Item_consulta / Remover</h4>
								...
								<div class="panel-body" style="margin-top:10px;">
									...
									<form id="form_usuario" class="form-horizontal" method="post">
										<div class="alert alert-danger" role="alert">
											...
											<div class="col-sm-10">
												<input type="text" disabled="" class="form-control" value="<?php echo set_value("dia_semana_id", $item->dia_semana_id); ?>" name="dia_semana_id" id="dia_semana_id">
											</div>
										</div>
																				<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" disabled="" class="form-control" value="<?php echo set_value("periodo_consulta_id", $item->periodo_consulta_id); ?>" name="periodo_consulta_id" id="periodo_consulta_id">
											</div>
										</div>
																				<div class="form-group">
