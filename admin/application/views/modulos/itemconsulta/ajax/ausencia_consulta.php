						...
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading clearfix">
									<h4 class="panel-title">Confirmação de Ausência em Consulta</h4>
								</div>
								<div class="" style="margin-top:10px;">
									<div class="alert alert-danger">
										<strong><i class="fa fa-times"></i></strong> <?php echo "Confirma a data da ausência do paciente à consulta."; ?>
									</div>
