                    ...
                    <div class="row">
                        <div class="col-md-4 left">
                            <div class="login-box">
                                <div class="panel">
                                    <div class="logo-box">
                                        <a href="<?php echo base_url(); ?>" class="logo-text text-center"><span>Sistema Clínico</span></a>
                        ...
                        <div class="col-md-8 infos-unidade">
                            <h3 class="infos-titulo">Sejam bem-vindos ao Sistema Clínico.</h3>
                            <p class="infos-destaques"><i class="fa fa-arrow-right"></i> Aqui você encontrará tudo sobre :</p>
                            <p class="infos-destaques"><i class="fa fa-book"></i> Os agendamentos classificados por períodos.</p>
                            <p class="infos-destaques"><i class="fa fa-money"></i> Um controle financeiro da sua unidade.</p>
                            <p class="infos-destaques"><i class="fa fa-users"></i> Acompanhamento no Gerenciamento de todos seus clientes.</p>
                            <p class="infos-destaques"><i class="fa fa-archive"></i> Toda a documentação essencial para sua unidade.</p>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
            </div><!-- Page Inner -->
