...
<head>
  ...
  <meta name="description" content="Clinica Reintegrar Dashboard">
  <meta name="author" content="Clinica Reintegrar">
  <title>Clinica Reintegrar - Dashboard</title>
  <!-- Favicon -->
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-examples">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>imoveis" class="nav-link">Listar Consultas</a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>imoveis/criar" class="nav-link">Adicionar Consultas</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-components">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>pages/components/buttons.html" class="nav-link">Listar Pacientes</a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>pages/components/cards.html" class="nav-link">Adicionar Pacientes</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-forms">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>pages/forms/elements.html" class="nav-link">Listar Planos</a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>pages/forms/components.html" class="nav-link">Adicionar Planos</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-tables">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>pages/tables/tables.html" class="nav-link">Dashboard</a>
                  </li>
                </ul>
              </div>
            </li>
